...
VECTOR_SEARCH_TOOL = VectorSearchRetrieverTool(
    index_name="agents.main.first_index_test_foodly",
    tool_name="meal_care_policy_retrieval_tool",
    num_results=2,
    tool_description="Use this tool to search the Meal knowledge base for policies, procedures, and service-related information. It retrieves the most relevant chunks from the company’s official documentation, including refund rules, cancellation terms, delivery guidelines, loyalty program details, privacy policies, and escalation procedures"
)
